...
public class ItemDataBase : MonoBehaviour
{
   ...
   //　アイテムデータのリスト
    ...
    void Awake()
    {
        ...
        itemDataList.Add(new ItemData("Item5", ItemType.Ore1, "<size=84><b>黒い鉱石</b>\n<size=60>ずっしりと重たい。", 0, 1.5f));
        itemDataList.Add(new ItemData("Item6", ItemType.Ore2, "<size=84><b>軽い鉱石</b>\n<size=60>軽くて簡単に持てる。", 0, 0.3f));
        itemDataList.Add(new ItemData("Item7", ItemType.Ore3, "<size=84><b>とげとげの鉱石</b>\n<size=60>採るのに体力を多く使う。", 0, 1.2f));
    }
